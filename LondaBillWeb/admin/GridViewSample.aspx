<%@ Page Language="C#" AutoEventWireup="true" Inherits="test" Codebehind="GridViewSample.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server"  AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="UserName" DataSourceID="ObjectDataSource1" AllowSorting="True">
                <Columns>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" SortParameterName="SortData"
